 ...
 * @returns {array} ["0 is even", "1 is odd", "2 is even", "3 is odd"] if max was 3
 */
 ...
 * @returns {array} [0, 9, 18, 27, 36, 45] if x was 5. 
* 0 * 9 = 0
* 1 * 9 = 9
* 2 * 9 = 18
* 3 * 9 = 27
 ...
 * @param {number} min number 
 * @param {number} max number 
 * @returns {array} all odd numbers in range decreasing
 */
function rangeOdd() {}
 ...
 * @param {number} min number 
 * @param {number} max number 
 * @returns {array} includes every other element
 */
...
/**
 * Takes in an array. 
 * Returns a new array where each element has been multiplied by it's index. 
